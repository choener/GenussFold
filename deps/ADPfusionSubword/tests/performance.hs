...
import           ADP.Fusion.Subword hiding (Split)
...
runLeftForward :: VU.Vector Int -> Unboxed (Subword I) Int -> Z:.TwITbl Id Unboxed EmptyOk (Subword I) Int
...
main = do
  es <- sequence
    ...
    , benchmark     2 ("bench-2000.csv") mkArrs runLeft 2000
    ]
